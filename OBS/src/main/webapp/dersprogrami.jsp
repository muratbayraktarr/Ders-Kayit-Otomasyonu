...
<html>
    ...
    <main id="main" class="main">
        ...
        <%
            ...
            ArrayList<Lesson> DersProgramiListesi = dp.DersProgramiGet(user_id);
        ...
        <div class="table-container">
            <table class="table table-bordered">
                <thead>
                    <tr class="table table-dark">
                        <th scope="col" colspan="5">Pazartesi</th>                    
                    </tr>
                    <tr class="table table-primary">
                        <th scope="col">Saat</th>
                        <th scope="col" colspan="2" >Ders Adı</th>
                        <th scope="col" colspan="2" >Sınıf</th>
                    </tr>
                </thead>          
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><%= lesson.getClassroom()%></td>                    
                    </tr>
                    <% } %>
                    <% }%>
                </tbody>   
            ...
            <table class="table table-bordered">
                <thead>
                    <tr class="table table-dark">
                        <th scope="col" colspan="5">Salı</th>                    
                    </tr>
                    <tr class="table table-primary">
                        <th scope="col">Saat</th>
                        <th scope="col" colspan="2" >Ders Adı</th>
        ...
        <div class="table-container">           
            <table class="table table-bordered">
                <thead>
                    <tr class="table table-dark">
                        <th scope="col" colspan="5">Çarşamba</th>                    
                    </tr>
                    <tr class="table table-primary">
                        <th scope="col">Saat</th>
                        <th scope="col" colspan="2" >Ders Adı</th>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr class="table table-dark">
                        <th scope="col" colspan="5">Perşembe</th>                    
                    </tr>
                    <tr class="table table-primary">
                        <th scope="col">Saat</th>
                        <th scope="col" colspan="2" >Ders Adı</th>
        ...
        <table class="table table-bordered">
            <thead>
                <tr class="table table-dark">
                    <th scope="col" colspan="5">Cuma</th>                    
                </tr>
                <tr class="table table-primary">
                    <th scope="col">Saat</th>
                    <th scope="col" colspan="2" >Ders Adı</th>
